...
public class ArticleAdminController {
  ...
  @RequestMapping(
      ...
      params = {"articleId", "action"})
  public @ResponseBody
  JsonMessage articleAction(@RequestParam("articleId") String articleId,
  ...
  public @ResponseBody
  JsonMessage articleCategoryChange(@RequestParam("articleId") String articleId,
  ...
  @RequestMapping(
      ...
      method = RequestMethod.GET,
      params = {"articleId"})
  public String articleEdit(@RequestParam("articleId") String articleId,
  ...
  @RequestMapping(
      value = "/article/edit",
      method = RequestMethod.POST,
      params = {"articleId", "articleTitle",
          "articleContent", "tag", "articleRawContent", "articleBgUrl"})
  public @ResponseBody
  JsonMessage articlePost(@RequestParam(name = "articleId") String articleId,
                          ...
                          @RequestParam(name = "articleBgUrl") String articleBgUrl) {
    ...
    article.setArticleBgUrl(articleBgUrl);
